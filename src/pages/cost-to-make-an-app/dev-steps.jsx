...
const DevStepsSignUpPage = ({ location }) => {
    ...
    return (
        <>
            ...
            <section className="full-section">
                <HeaderPlaceholder />
                <PricingMoreLayout PricingEstimateLayout={PricingEstimateLayout} section={2} route={location.pathname} />
            </section>
        </>
    );
};

DevStepsSignUpPage.propTypes = {
...
export default DevStepsSignUpPage;
